...
\begin{document}
    ...
    \begin{table}
        ...
        \hline
        \begin{tabular}[c]{@{}l@{}}Unsupervised\\layer-wise pre-training\end{tabular} & 0.97110       & 0.00863     & 0.01564      & 11.12283           \\ 
        \hline
    ...
    \begin{table}
        ...
        \centering
        \caption{Efficiency data for all methods}
        \begin{tabular}{|l|l|l|l|} 
        \hline
        \textbf{Method}                                                               & \begin{tabular}[c]{@{}l@{}}\textbf{Total Training }\\\textbf{Time (s)}\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{Training Dataset }\\\textbf{Size (count)}\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{\textbf{Percentage Utilisation of }}\\\textbf{\textbf{Full Training Dataset (\%)}}\end{tabular}  \\ 
        \hline
        Baseline                                                                      & 198.602                                                                             & 14600                                                                                     & 100                                                                                                                                 \\ 
        \hline
        Mixed-precision                                                               & 236.306                                                                             & 14600                                                                                     & 100                                                                                                                                 \\ 
        \hline
        \begin{tabular}[c]{@{}l@{}}Supervised \\layer-wise pre-training\end{tabular}  & \textcolor[rgb]{0.125,0.129,0.141}{154.9519}                                        & 14600                                                                                     & 100                                                                                                                                 \\ 
        \hline
        \begin{tabular}[c]{@{}l@{}}Unsupervised\\layer-wise~pre-training\end{tabular} & \textcolor[rgb]{0.125,0.129,0.141}{117.389}                                         & 14600                                                                                     & 100                                                                                                                                 \\ 
        \hline
        Active learning                                                               & 292.042                                                                             & 9100                                                                                      & 62.33                                                                                                                               \\
        \hline
        \end{tabular}
    ...
    \begin{table}
        ...
        \centering
        \caption{Table enumerating the final 5 values of the vola}
        ...
        \hline
        None (baseline)                                                                & -                                                                                & -                                                                       & -                                                                       & -                                                                       & -                                                                          & 198.602                                                                             \\ 
        \hline
        Supervised                                                                     & 107.886                                                                          & 32.6                                                                    & 29.0                                                                    & 38.4                                                                    & 47.0659                                                                    & \textcolor[rgb]{0.125,0.129,0.141}{154.9519}                                        \\ 
        \hline
        Unsupervised                                                                   & 51.8425                                                                          & 31.8                                                                    & 40.4~                                                                   & 27.8                                                                    & 65.5465                                                                    & \textcolor[rgb]{0.125,0.129,0.141}{117.389}                                         \\
        \hline
        \end{tabular}
    ...
    \begin{figure}[ht]
        ...
        \centering
        \includegraphics[width=0.6\textwidth]{results/all-predictions.png}
