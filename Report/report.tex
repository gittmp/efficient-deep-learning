...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item \emph{Improving the inclusivity of finance}. Lowering the resource requirements of deep learning for finance lowers the  the bar-to-entry to engage in this work, allowing more individuals to leverage financial technology and analytics.
    \end{enumerate}
