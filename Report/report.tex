...
\begin{document}
    ...
    The results of the experimentation presented in Chapter \ref{chapter: experiments} are explored in the following section. Initially, the data collected from analyses of the implemented methods is presented, summarising what is shown by the research findings, highlighting their significance, and examining their implications for the research hypotheses. Following this, a detailed discussion surrounding the success of each experiment is undertaken, evaluating the accuracy and efficiency of each presented method to deduce how effective these Green AI approaches are at reducing the computational cost of DNN training within the chosen application of LSTM-based financial market volatility forecasting. The results and discussion are broken down into the three constituent experiments of this research; initially, the baseline model is tested and its computational cost quantified, giving a baseline against which the efficiency-focussed adaptations can be compared. Secondly, the results indicating the success of the energy-efficient extensions in reducing the training time and memory usage of the implemented DNN are explored. Finally, the reduction in data requirements facilitated by the implemented data-efficient extensions is quantified, exploring their benefit to reducing the computational cost of training DNNs. The results of this research aim to demonstrate the success of Green AI in reducing the computational cost of DL, in the context of financial volatility forecasting and Fintech in general; this is in an attempt to showcase a possible avenue for improving the sustainability of DL for finance, minimising the ESG impacts of Fintech and the financial sector as a whole.
    ...
    \begin{table}
        ...
        \begin{tabular}{|l|l|l|l|l|} 
            ...
            \hline
            Baseline                                                                      & 0.979005        & 0.009249      & 0.013334       & 12.392648            \\ 
            \hline
            Mixed-precision                                                               & 0.982433        & 0.007852      & 0.012197       & 11.091287             \\ 
            \hline
            \begin{tabular}[c]{@{}l@{}}Supervised\\layer-wise pre-training\end{tabular}   & 0.990164        & 0.006247      & 0.009127       & 8.522277             \\ 
            \hline
            \begin{tabular}[c]{@{}l@{}}Unsupervised\\layer-wise pre-training\end{tabular} & 0.98098        & 0.00830      & 0.01269       & 9.90137            \\ 
            \hline
            Active Learning                                                               & 0.97041        & 0.00859      & 0.01583       & 10.44452            \\
            \hline
        \end{tabular}
        \caption{Accuracy data for all methods, evaluated over the testing datset.}
    \end{table}
    ...
    \begin{table}
        ...
        \begin{tabular}{|l|l|l|} 
        \hline
        \textbf{Method}                                                               & \begin{tabular}[c]{@{}l@{}}\textbf{Total Training}\\\textbf{Time (s)}\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{Training Dataset}\\\textbf{Size (count)}\end{tabular}  \\ 
        \hline
        Baseline                                                                      & 207.863                                                                            & 14600                                                                                     \\ 
        \hline
        Mixed-precision                                                               & 219.779                                                                            & 14600                                                                                     \\ 
        \hline
        \begin{tabular}[c]{@{}l@{}}Supervised \\layer-wise pre-training\end{tabular}  & 190.5344                                                                           & 14600                                                                                     \\ 
        \hline
        \begin{tabular}[c]{@{}l@{}}Unsupervised\\layer-wise~pre-training\end{tabular} & 152.8665                                                                           & 14600                                                                                     \\ 
        \hline
        Active learning                                                               & 343.369                                                                            & 10100                                                                                     \\
        \hline
        \end{tabular}
        \caption{\centering Efficiency results for all methods.}
    \end{table}
    ...
    \begin{table}
        ...
        \hline
        \begin{tabular}[c]{@{}l@{}}\textbf{\footnotesize Pre-Training}\\\textbf{\footnotesize Method}\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{\footnotesize Pre-Training}\\\textbf{\footnotesize Time~(s)}\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{\footnotesize Layer 1}\\\textbf{\footnotesize (\%)}\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{\footnotesize Layer 2}\\\textbf{\footnotesize (\%)}\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{\footnotesize Layer 3}\\\textbf{\footnotesize (\%)}\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{\footnotesize Tuning}\\\textbf{\footnotesize Time (s)}\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{\footnotesize Total Training}\\\textbf{\footnotesize Time~(s)}\end{tabular}  \\ 
        \hline
        None (baseline)              & -                                                                                                  & -                                                                                      & -                                                                                                       & -                                                                                                       & -                                                                          & 207.863                                                                       \\ 
        \hline
        Supervised                   & 126.684                                                                                            & 34.6                                                                                   & 32.7                                                                                                    & 32.7                                                                                                    & 63.8504                                                                    & 190.5344                                                                      \\ 
        \hline
        Unsupervised                 & 52.2105                                                                                             & 44.6                                                                                   & 26.3                                                                                                    & 29.1                                                                                                    & 100.656                                                                    & 152.8665                                                                      \\
        \hline
        \end{tabular}
    ...
    \begin{figure}[ht]
        ...
        \centering
        \includegraphics[width=0.8\textwidth]{traintest-split.png}
        \caption{\centering Predicted volatility time series of each tested model (orange dashed line) against the true volatility time series (blue).}
    \end{figure}
    ...
    \begin{figure}[ht]
        ...
        \centering
        \includegraphics[width=0.8\textwidth]{traintest-split.png}
        \caption{\centering Progression of each model's accuracy over the training process, evaluating its RMSE over the training dataset (blue line) and a validation set of instances held back from training (orange) after each epoch.}
    \end{figure}

    \begin{figure}[ht]
        \label{fig: sup-progressive-accuracy}
        \centering
        \includegraphics[width=0.8\textwidth]{traintest-split.png}
        \caption{\centering Progression of the accuracy (MAE and RMSE) of the model using supervised layer-wise pre-training over both pre-training and full network tuning (evaluated at each epoch over the distinct training and validation data).}
    \end{figure}

    \begin{figure}[ht]
        \label{fig: unsup-progressive-accuracy}
        \centering
        \includegraphics[width=0.8\textwidth]{traintest-split.png}
        \caption{\centering Progression of the accuracy (MAE and RMSE) of the model using unsupervised layer-wise pre-training over both pre-training and full network tuning (evaluated at each epoch over the distinct training and validation data).}
    \end{figure}
