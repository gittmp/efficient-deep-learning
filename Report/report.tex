...
\begin{document}
    ...
    \section{Evaluating Energy Efficiency}
    ...
    \begin{figure}[ht]
        ...
        \centering
        \includegraphics[width=0.8\textwidth]{results/all-training-rmse.png}
    ...
    \begin{figure}[ht]
        ...
        \centering
        \includegraphics[width=0.8\textwidth]{results/loss-suplayerwise.png}
    ...
    \begin{figure}[ht]
        ...
        \centering
        \includegraphics[width=0.8\textwidth]{results/loss-unsuplayerwise.png}
